    ...
    return (
      <div className='forgot-main'>
        <div>
          ...
          <label className='forgot-input-container'><input type="text" placeholder='Your email address *' className='forgot-input forgot-arimo-12'/></label>
          <BlackButton text="Reset"/>
          <div className='forgot-color-black forgot-arimo-12 forgot-back' onClick={() => {pageHandler("login")}}>Back to Login</div>
        </div>
      </div>
    )
  }
